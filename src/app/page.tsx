...
import { BookOpenCheckIcon, Brain, BrainCircuitIcon, FileSlidersIcon, SpeechIcon } from "lucide-react";
      ...
      <div className="container">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">Prep With Me</h1>
          </div>
          <Suspense
            fallback={
